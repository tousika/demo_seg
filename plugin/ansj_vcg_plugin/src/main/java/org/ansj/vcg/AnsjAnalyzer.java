package org.ansj.vcg;

import org.ansj.library.*;
import org.ansj.vcg.AnsjTokenizer;
...
public class AnsjAnalyzer extends Analyzer {
	...
	public AnsjAnalyzer(TYPE type, String userDefineKey) {
		this.args = new HashMap<String, String>();
		args.put("type", type.name());
		args.put(DicLibrary.DEFAULT_NATURE, userDefineKey);
	}
	...
	public static Tokenizer getTokenizer(Reader reader, Map<String, String> args) {
		...
		String userkey = args.containsKey(DicLibrary.DEFAULT_NATURE)?args.get(DicLibrary.DEFAULT_NATURE):"";
		switch (AnsjAnalyzer.TYPE.valueOf(type)) {
		case base_ansj:
			analysis = new BaseAnalysis();
			break;
		case index_ansj:
			analysis = new IndexAnalysis(userkey);
			break;
		case dic_ansj:
			analysis = new DicAnalysis(userkey);
			break;
		case query_ansj:
			analysis = new ToAnalysis(userkey);
			break;
		case nlp_ansj:
