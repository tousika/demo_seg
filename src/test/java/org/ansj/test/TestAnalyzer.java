...
import org.ansj.recognition.impl.UnigramMergeRecognition;
...
//        System.out.println(ToAnalysis.parse(segment).recognition(re));
        String segment="64岁濮存昕将演绎《李尔王》飚演技 胡须花白一脸桀骜个性十足";
//        segment="游云谷";
        Result result =ToAnalysis.parse("dic_editoral",segment);
